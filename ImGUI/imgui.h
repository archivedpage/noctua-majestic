...
namespace ImGui
{
    ...
    IMGUI_API ImU32         GetColorU32(const ImVec4& col, float alpha_mul = 1.f);                               // retrieve given color with style alpha applied, packed as a 32-bit value suitable for ImDrawList
    ...
    IMGUI_API void          Combo( const char* label, int* v, std::vector< const char* > items );
    IMGUI_API bool          Checkbox(const char* label, bool* v, int* key = 0, std::vector< float* > col = { }, void ( *settings )( ) = 0);
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_NoDecoration           = ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoCollapse,
...
struct ImDrawList
{
    ...
    IMGUI_API void  AddRectFilledMultiColorRounded2(const ImVec2& p_min, const ImVec2& p_max, ImU32 bg_color, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding, ImDrawFlags rounding_corners);
    IMGUI_API void  AddRectFilledMultiColor3(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0.f, ImDrawFlags flags = 0.f);
